...
CODEMO built the OBD Fuel app as a Free app. This SERVICE is provided by CODEMO at no cost and is intended for use as is.
...
We do not collect any data. These are the services that will require by the app to function.

*Location Service*
Location access is used to discover nearby Bluetooth devices, which will find the nearby OBD devices and let user select one OBD device.

*Bluetooth Service*
Bluetooth access is used to communicate with the OBD device.
